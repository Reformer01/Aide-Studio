...
const MatterBody = ({
  ...
  }, [props, children, matterBodyOptions, isDraggable, x, y, angle, bodyType, sampleLength, context])
  ...
  (
    ...
    const initializeRenderer = useCallback(() => {
      ...
      import("poly-decomp").then((polyDecomp) => {
        Common.setDecomp(polyDecomp.default);
      });
    ...
    }, [stopEngine, handleResize, startEngine])
